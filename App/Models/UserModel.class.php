<?php
    ...
    class UserModel extends \Core\Model{
        ...
        public function register(){
            ...
            $this->dbcon->insert('user', ['username'=>new DBString($this->username), 'password'=>new DBRaw("md5('{$this->password[0]}')"), 'email'=>new DBString($this->email), 'address'=>'', 'district_id'=>new DBRaw('null'), 'birthday'=>new DBDate($this->day, $this->month, $this->year), 'gender'=>new DBNumber($this->gender), 'role'=>new DBNumber(0)]);
        }
